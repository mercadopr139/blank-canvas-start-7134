  ...
  public: {
    Tables: {
      ...
      attendance_records: {
        ...
        Relationships: [
          {
            foreignKeyName: "attendance_records_excursion_id_fkey"
      ...
      excursion_personnel: {
        ...
        Relationships: [
          {
            foreignKeyName: "excursion_personnel_excursion_id_fkey"
            columns: ["excursion_id"]
            isOneToOne: false
            referencedRelation: "excursions"
            referencedColumns: ["id"]
      ...
      excursion_vehicle_assignments: {
        ...
        Relationships: [
          {
            foreignKeyName: "excursion_vehicle_assignments_excursion_id_fkey"
            columns: ["excursion_id"]
            isOneToOne: false
            referencedRelation: "excursions"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "excursion_vehicle_assignments_registration_id_fkey"
            columns: ["registration_id"]
            isOneToOne: false
            referencedRelation: "youth_registrations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "excursion_vehicle_assignments_vehicle_id_fkey"
            columns: ["vehicle_id"]
            isOneToOne: false
      ...
      excursion_vehicles: {
        ...
        Relationships: [
          {
            foreignKeyName: "excursion_vehicles_excursion_id_fkey"
            columns: ["excursion_id"]
            isOneToOne: false
            referencedRelation: "excursions"
            referencedColumns: ["id"]
    ...
    Functions: {
      add_excursion_personnel: {
        Args: { _excursion_id: string; _name: string }
        Returns: string
      }
      add_excursion_vehicle: {
        Args: {
          _driver_name: string
          _excursion_id: string
          _name: string
          _seat_cap: number
        }
        Returns: string
      ...
      assign_youth_to_vehicle: {
        Args: { _registration_id: string; _vehicle_id: string }
        Returns: undefined
      }
      coach_add_late_arrival: {
        Args: {
          _excursion_id: string
      ...
      confirm_excursion_arrival: {
        Args: { _excursion_id: string; _note?: string }
        Returns: string
      }
      confirm_excursion_return: {
        Args: { _excursion_id: string; _note?: string }
        Returns: string
      }
      decrement_meal_count: { Args: { _event_id: string }; Returns: number }
      excursion_clear_transportation: {
        Args: { _excursion_id: string }
        Returns: undefined
      }
      get_excursion_checkin_count: {
        Args: { _excursion_id: string }
        Returns: number
      }
      get_excursion_personnel: {
        Args: { _excursion_id: string }
        Returns: {
          created_at: string
          id: string
      ...
      lock_excursion_roster: {
        Args: { _excursion_id: string }
        Returns: string
      }
      remove_excursion_personnel: {
        Args: { _personnel_id: string }
        Returns: undefined
      }
      remove_excursion_vehicle: {
        Args: { _vehicle_id: string }
        Returns: undefined
      }
      search_excursion_youth: {
        Args: { _search: string }
        Returns: {
          child_boxing_program: Database["public"]["Enums"]["boxing_program"]
          child_first_name: string
      ...
      set_excursion_arrived_at: {
        Args: { _arrived_at: string; _excursion_id: string }
        Returns: undefined
      }
      set_excursion_returned_at: {
        Args: { _excursion_id: string; _returned_at: string }
        Returns: undefined
      }
      set_excursion_transportation_required: {
        Args: { _excursion_id: string; _required: boolean }
        Returns: undefined
      }
      unassign_youth_from_vehicle: {
        Args: { _excursion_id: string; _registration_id: string }
        Returns: undefined
      }
      unlock_excursion_roster: {
        Args: { _excursion_id: string }
        Returns: undefined
      }
