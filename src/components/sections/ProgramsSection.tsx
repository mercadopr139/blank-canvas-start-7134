  ...
  return <section id="programs" className="bg-primary py-[30px] md:py-[60px]">
      <div className="container">
        ...
        <div className="text-left mb-16">
          ...
          <p className="text-lg md:text-xl text-primary-foreground/70 max-w-3xl leading-relaxed">We offer <span className="underline">two core programs</span> designed to meet youth where they are and grow with them over time. Each program includes <span className="font-bold text-primary-foreground/70">boxing & fitness training</span>, mentorship, support, and opportunities for <span className="font-bold text-[#bf0f3e]">personal, professional, and spiritual</span> development.</p>
        </div>
