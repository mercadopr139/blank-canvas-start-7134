      ...
      <Dialog open={signupModalOpen === "senior"} onOpenChange={open => !open && setSignupModalOpen(null)}>
        <DialogContent className="max-w-lg">
          ...
          <div className="mt-4 space-y-1.5">
            ...
            <p className="text-muted-foreground italic text-xs flex items-center gap-2">What to bring: Athletic clothes & sneakers<Shirt className="h-3.5 w-3.5 text-foreground flex-shrink-0" /> What to bring: athletic clothes & sneakers
            </p>
            <p className="text-muted-foreground italic text-xs flex items-center gap-2">
