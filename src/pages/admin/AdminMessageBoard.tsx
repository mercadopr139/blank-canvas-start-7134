...
import { ArrowLeft, MessageSquare, Signal } from "lucide-react";
...
const AdminMessageBoard = () => {
  ...
  // Re-fetch the active thread and the list whenever any message inserts
  // anywhere (cheap at small scale; revisit if conversation count grows).
  useEffect(() => {
    if (!user) return;
