      ...
      <Dialog open={modalOpen} onOpenChange={(o) => {if (!o) setModalOpen(false);}}>
        <DialogContent
          ...
          <div className="overflow-y-auto flex-1 px-6 pb-4 space-y-4 pt-2">
            ...
            <div className="space-y-1.5">
              <SupporterAutocomplete
                ...
                onChange={(val) => {
                  ...
                  if (isNewSupporter) {
                    setSupporterDetails((prev) => ({ ...prev, name: val }));
                  }
                  if (!val) {
            ...
            <div className={`rounded-lg p-4 space-y-3 ${isNewSupporter ? "bg-zinc-900 border border-green-500/30 shadow-[0_0_12px_rgba(34,197,94,0.06)]" : "bg-zinc-800/60 border border-white/[0.08]"}`}>
                <div>
