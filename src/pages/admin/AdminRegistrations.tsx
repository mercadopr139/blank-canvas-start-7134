     ...
     <div className="min-h-screen bg-muted/30">
       <header className="bg-background border-b border-border">
         <div className="container mx-auto px-4 py-4 flex items-center gap-4">
           ...
           <div>
             <h1 className="text-xl font-bold text-foreground">Youth Registrations</h1>
                   ...
                   <TableBody>
                     {filteredRegistrations?.map((reg) => (
                       <TableRow key={reg.id}>
                         ...
                         <TableCell>{calculateAge(reg.child_date_of_birth)}</TableCell>
                         <TableCell>
                         ...
                         <TableCell className="text-sm">{reg.child_school_district}</TableCell>
                         <TableCell>
