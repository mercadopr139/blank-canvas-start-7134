          ...
          <div className="container">
            <div className="max-w-[1200px] mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                {[{ src: facilityFinishedGymNew, alt: "The Finished Boxing Facility" }, { src: facilityFinishedCourtNew, alt: "The Finished Performance Center" }, { src: facilityFinishedLearningCenter, alt: "The Finished Learning Center" }, { src: facilityFinishedTeenCenter, alt: "The Finished Smile Lab" }].
                map((img, idx) =>
