          ...
          <div className="container">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
                ...
                <p className="font-semibold text-foreground">Our model combines personal, professional, and spiritual development—alongside education, discipline, and hard work—to create lasting transformation.
